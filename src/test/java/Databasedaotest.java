...
class DatabaseDAOTest {
    ...
    void testAddAndRetrieveClient() throws SQLException {
        Client client = new Client(0,"Monsef", "RH", "monsef.rh@example.com", "5554443333", "789 Elm St",new ArrayList<>());
        ...
        assertEquals("Monsef", retrievedClient.getFirstName());
        assertEquals("RH", retrievedClient.getLastName());
        assertEquals("monsef.rh@example.com", retrievedClient.getEmail());
        assertEquals("5554443333", retrievedClient.getPhone());
    ...
    void testAddAndRetrieveAccount() throws SQLException {
        Client client = new Client(0,"Monsef", "RHOUDDANI", "monsef.rhouddani@example.com", "5554443333", "789 Elm St",new ArrayList<>());
        databaseDAO.addClient(client);
